...
LOGCURDIR := $(shell /bin/pwd -L)

include pre/macros.mak

$(call ErrorIfUndefined,BuildProduct)

AllProductMakefilesWithPath = $(sort $(wildcard $(BuildRoot)/product/*/*/build/*.mak))
...
ifndef MakeBuildTuple
export MakeBuildTuple		= $(if $(1),$(call Slashify,$(1)),)$(if $(3),$(call Slashify,$(2)),$(2))$(if $(3),$(3),)
endif
...
ifndef UnconditionalBuildTuple
export UnconditionalBuildTuple	:= $(call MakeBuildTuple,$(BuildProduct),$(ToolTuple),$(BuildConfig))
endif
...
include pre/version.mak
include pre/release.mak
