...
#      Collection (GCC) versions for OS X.
#
...
do-check-as: ToolSedArgs=$(GccSedArgs)
do-check-as: ToolGrepArgs=$(GccGrepArgs)
do-check-as: ToolDescription="GNU assembler"

do-check-cpp: ToolPath=$(CPP)
do-check-cpp: ToolSedArgs=$(GccSedArgs)
do-check-cpp: ToolGrepArgs=$(GccGrepArgs)
do-check-cpp: ToolDescription="GNU preprocessor"

do-check-gcc: ToolPath=$(CC)
do-check-gcc: ToolDescription="Clang C compiler"

do-check-g++: ToolPath=$(CXX)
do-check-g++: ToolDescription="Clang C++ compiler"

do-check-ld: ToolPath=$(LD)
do-check-ld: ToolSedArgs=$(GccSedArgs)
do-check-ld: ToolGrepArgs=$(GccGrepArgs)
