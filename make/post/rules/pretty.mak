...
# nl-make-pretty <OUTPUT COMMAND> <COMMAND> <COMMAND ARGUMENTS> <PATHS>
#
...
pretty: $(PrettyPaths)
ifneq ($(PRETTY),)
	$(call nl-make-pretty,$(PrettyVerbose),$(PRETTY),$(PRETTY_ARGS),$(filter-out $(@)-recursive,$(^)))
endif

pretty-check: $(PrettyPaths)
ifneq ($(PRETTY_CHECK),)
	$(call nl-make-pretty,$(PrettyCheckVerbose),$(PRETTY_CHECK),$(PRETTY_CHECK_ARGS),$(filter-out $(@)-recursive,$(^)))
endif
